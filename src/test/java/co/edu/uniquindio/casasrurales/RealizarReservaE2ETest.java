...
class RealizarReservaE2ETest {
    ...
    void prepararDatos() {
        // Propietario
        Propietario propietario = new Propietario("3009999999", null, null, null);
        propietarioRepository.save(propietario);

        // Casa valida (minimo: 1 foto, 3 habitaciones, 1 cocina, 2 banos)
        casaRural = new CasaRural(1, "Armenia", "Casa de prueba E2E", null, 1, 2, true);
        casaRural.setPropietario(propietario);
        casaRural.agregarFoto(new Foto());
        casaRural.agregarHabitacion(new Habitacion("HAB-1", 1, TipoCama.SENCILLA, false));
        casaRural.agregarHabitacion(new Habitacion("HAB-2", 2, TipoCama.DOBLE, true));
        casaRural.agregarHabitacion(new Habitacion("HAB-3", 1, TipoCama.SENCILLA, false));

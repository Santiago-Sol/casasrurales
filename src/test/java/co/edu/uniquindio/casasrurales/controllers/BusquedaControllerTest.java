...
class BusquedaControllerTest {
    ...
    void testBuscarPorPoblacion_OK() {
        CasaRuralListadoDTO casa = new CasaRuralListadoDTO(
                1, "Casa hermosa", "Salento", 3, 2, 1, "Casa hermosa", "Juan");
    ...
    @DisplayName("HU6-C03: GET /api/busqueda/por-poblacion poblacion vacia retorna BAD_REQUEST")
    @Test
    ...
    @DisplayName("HU6-C04: GET /api/busqueda/por-poblacion poblacion null retorna BAD_REQUEST")
    @Test
    ...
    void testBuscarPorCodigo_Encontrado() {
        CasaRuralDetalleDTO casa = new CasaRuralDetalleDTO(
                1, "Casa hermosa", "Salento", "Casa hermosa", 3, 2, 1, 1, 0, "Juan", "3008881111");
    ...
    @DisplayName("HU7-C03: GET /api/busqueda/codigo/buscar busca por parametro query - OK")
    @Test
    void testBuscarDetallePorCodigo_OK() {
        CasaRuralDetalleDTO casa = new CasaRuralDetalleDTO(
                5, "Casa moderna", "Armenia", "Casa moderna", 4, 3, 2, 2, 100000, "Maria", "3001234567");
    ...
    @DisplayName("HU7-C04: GET /api/busqueda/codigo/buscar codigo no valido retorna BAD_REQUEST")
    @Test
    ...
    @DisplayName("HU7-C05: GET /api/busqueda/codigo/buscar codigo vacio retorna BAD_REQUEST")
    @Test
    ...
    @DisplayName("HU7-C06: GET /api/busqueda/codigo/buscar codigo null retorna BAD_REQUEST")
    @Test
    ...
    @DisplayName("HU6-C07: Busqueda por poblacion normaliza espacios")
    @Test
    void testBuscarPorPoblacion_NormalizaEspacios() {
        CasaRuralListadoDTO casa = new CasaRuralListadoDTO(
                2, "Casa rustica", "Filandia", 2, 1, 0, "Casa rustica", "Pedro");
    ...
    @DisplayName("HU7-C08: Busqueda por codigo con espacios es normalizada")
    @Test
    void testBuscarDetallePorCodigo_NormalizaEspacios() {
        CasaRuralDetalleDTO casa = new CasaRuralDetalleDTO(
                3, "Casa acogedora", "Circasia", "Casa acogedora", 2, 2, 1, 1, 50000, "Carlos", "3009876543");
